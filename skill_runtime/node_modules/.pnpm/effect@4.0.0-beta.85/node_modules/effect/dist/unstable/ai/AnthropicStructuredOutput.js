    ...
    case "Arrays":
      {
        ...
        if (ast.elements.length > 0) {
          ...
          return SchemaAST.decodeTo(recur(new SchemaAST.Objects(propertySignatures, [], annotations, filters)), ast, SchemaTransformation.transform({
            decode: o => {
              let t = [];
    ...
    case "Objects":
      {
        ...
        if (ast.indexSignatures.length === 0) {
          ...
          return SchemaAST.decodeTo(recur(new SchemaAST.Arrays(false, [], [new SchemaAST.Arrays(false, [is.parameter, is.type], [])], annotations)), ast, SchemaTransformation.transform({
