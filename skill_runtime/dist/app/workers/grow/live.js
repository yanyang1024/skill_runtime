...
export async function runGrowLive(skillId, plan) {
...
function generateUpdateContent(target, skillId) {
...
function generateCreateContent(target, skillId) {
...
function generateQualityGateYaml() {
    return `checks:
  - id: references_exist
